import 'package:brigdeWork_app/LikedPage.dart';
import 'package:brigdeWork_app/RequestPage.dart';
...
class WorkerSettingsPage extends StatefulWidget {
  ...
  const WorkerSettingsPage({
    ...
    this.currentAvailability = const [],
    this.currentBio = '',
  });
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => EditProfileWorker(
                                selectedWork: widget.currentSkills,
                                selectedAvailability:
                                    widget.currentAvailability,
